...
The shifter is implemented as a barrel shifter, allowing shifts of any amount to be performed in a single cycle. The design is organized in a series of stages, each responsible for shifting by a power of two (1, 2, 4, 8, \ldots). At each stage, multiplexers select either the shifted or unshifted version of the operand based on the corresponding bit of the shift amount. 
